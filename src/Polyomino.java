...
public class Polyomino{
	// un tuple est stock� comme un tableau de deux entiers
	ArrayList<int[]> cases = new ArrayList<int[]>(); 
	
	// On ajoute �galement les cases_voisines (utilis� pour g�n�rer des polyominos)
	ArrayList<int[]> casesVoisines;
	
	// Pour tester l'�galit�, on garde en m�moire la case en bas � gauche en permanence
	Integer[] case0;
	...
	Polyomino(String s){ 
		...
		while(i < l){
			...
			if(car == '('){
				...
				int[] coordonnees = {Integer.parseInt(x),Integer.parseInt(y)}; //fonction qui convertit une cha�ne en entier
	...
	// fonction qui compare 2 polyominos de m�me aire
